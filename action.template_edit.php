...
$form->setWidget('restore_template_from', 'select', array('values' => array_merge(array('select' => $this->lang('select one')),MCMedias::$frontend_templates)));
$form->setWidget('default_template_for', 'select', array('values' => array_merge(array('select' => $this->lang('select one')),MCMedias::$frontend_templates)));
