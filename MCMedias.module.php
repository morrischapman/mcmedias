...
class MCMedias extends CMSModule
{
    ...
    {
        return $this->CheckAccess('Manage MC Medias');
    }

    public function CheckAccess($perm = 'Manage MCMedias')
    {
    ...
    public function getThumbnail($params)
    {
        ...
        if (isset($params['size'])) {
            $params['width'] = (int)$params['size'];
            $params['height'] = (int)$params['size'];
        }
